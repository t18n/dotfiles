return {
  {
    ...
    keys = {
      ...
      { "<leader>f", require("turbo.util").telescope("find_files"), desc = "Find files" },
      -- { "<leader>F",  "<cmd>Telescope live_grep<cr>",                           desc = "Find Text" },
      { "<leader>F", require("turbo.util").telescope("live_grep"), desc = "Find Text" },
    },
    -- config = function() require("turbo.config.telescope") end,
  },
